...
{    
    // This is the number of nodes in the network
    public static final int NUMNODES = 8;
    ...
    public DVRoute()
    {
      ...
      /*  neighbors = new int[NUMNODES][];
        ...
        neighbors[3] = new int[] {1, 5, 6};
        neighbors[4] = new int[] {1, 2, 6, 7};
        neighbors[5] = new int[] {3, 6};
        neighbors[6] = new int[] {2, 3, 4, 5, 7};
        neighbors[7] = new int[] {4, 6};
